...
.method static constructor <clinit>()V
    ...
    .line 1
    invoke-static {}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->ajc$preClinit()V
...
.method private static synthetic ajc$preClinit()V
    ...
    const-string v0, "NavigationMenuPresenter.java"

    const-class v1, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;
    ...
    const-string v3, "android.support.design.internal.NavigationMenuPresenter$NavigationMenuAdapter"

    const-string v4, "android.support.design.internal.NavigationMenuPresenter$ViewHolder:int"
    ...
    sput-object v0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->ajc$tjp_0:Lorg/aspectj/lang/JoinPoint$StaticPart;
...
.method static final synthetic onBindViewHolder_aroundBody0(Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;ILorg/aspectj/lang/JoinPoint;)V
    .locals 1
    ...
    .line 428
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget-object p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->iconTintList:Landroid/content/res/ColorStateList;

    invoke-virtual {p1, p3}, Landroid/support/design/internal/NavigationMenuItemView;->setIconTintList(Landroid/content/res/ColorStateList;)V

    .line 429
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget-boolean p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->textAppearanceSet:Z
    ...
    iget p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->textAppearance:I

    invoke-virtual {p1, p3}, Landroid/support/design/internal/NavigationMenuItemView;->setTextAppearance(I)V

    .line 432
    :cond_0
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget-object p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->textColor:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p3}, Landroid/support/design/internal/NavigationMenuItemView;->setTextColor(Landroid/content/res/ColorStateList;)V

    .line 435
    :cond_1
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget-object p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->itemBackground:Landroid/graphics/drawable/Drawable;
    ...
    .line 438
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->items:Ljava/util/ArrayList;
    ...
    .line 439
    iget-boolean p3, p2, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->needsEmptyIcon:Z

    invoke-virtual {p1, p3}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V

    .line 440
    iget-object p3, p0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget p3, p3, Landroid/support/design/internal/NavigationMenuPresenter;->itemHorizontalPadding:I

    invoke-virtual {p1, p3}, Landroid/support/design/internal/NavigationMenuItemView;->setHorizontalPadding(I)V
    ...
    invoke-virtual {p1, p0, v0}, Landroid/support/design/internal/NavigationMenuItemView;->initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
...
.method public onBindViewHolder(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    sget-object v0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->ajc$tjp_0:Lorg/aspectj/lang/JoinPoint$StaticPart;
    ...
    new-instance v0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter$AjcClosure1;

    invoke-direct {v0, v2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter$AjcClosure1;-><init>([Ljava/lang/Object;)V
